...
// export class SqlProvider implements IDataProvider {
//     constructor() {
//     }
...
//     private match<T>(expression: QueryExpression<T>): Array<any> {
        
//         let matchList: [] = [];

//         if (typeof expression === "function") {
//             throw new Error("SQL - Express Match: Not implement yet.");
//         }

//         let con = expression.$with || "&&";
//         let where = expression.$where || [];
//         let isAnd = (con === "&&");
...
//         let matched = this.matchOnData(expression,);
//         if (!matched && isAnd) { return false; }
...
//         let list = this.match(qNode.expression);
